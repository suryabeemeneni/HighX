              ...
              <div className='props-main-div'>
                <div className='props-sub-div'>
                    ...
                    <div className='props-containers-main-div'>
                        ...
                        <div className='props-container2'>
                            <a href='' className='props-container2-link'><p className='props-container3-para'>Websites built with React like Facebook, Twitter, and Netflix use the same design patterns across many sections that just have different data. One of the main ways developers can achieve this functionality is by using props.
